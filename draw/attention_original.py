...
if __name__ == "__main__":
    ...
    W__ = att.read_large(I_, center_y_, center_x_, delta_, sigma_)

    do_read = theano.function(inputs=[I_, center_y_, center_x_, delta_, sigma_],
                              outputs=W_, allow_input_downcast=True)

    do_read_large = theano.function(inputs=[I_, center_y_, center_x_, delta_, sigma_],
                              outputs=W__, allow_input_downcast=True)
    ...
    I3 = do_read_large(I, center_y, center_x, delta, sigma)
    ...
    pylab.figure()
    pylab.gray()
    pylab.imshow(imagify(I3, height, width), interpolation='nearest')
