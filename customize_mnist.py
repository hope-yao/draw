...
def convert_mnist(directory, output_directory, output_filename=None,
    ...
    * `t10k-labels-idx1-ubyte.gz`
    ...
    # MAX hack
    temp_id = numpy.where(train_labels==3)[0]
    train_features = train_features[temp_id,:,:,:]
    train_labels = train_labels[temp_id]
    temp_id = numpy.where(test_labels==3)[0]
    test_features = test_features[temp_id,:,:,:]
    test_labels = test_labels[temp_id]
...
convert_mnist('./draw/datasets', './draw/datasets')